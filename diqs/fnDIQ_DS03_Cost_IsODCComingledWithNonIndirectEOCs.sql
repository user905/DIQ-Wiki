...
(
	/*
		...
		This function looks for WP/PP with a mix of ODC EOC and any 
		EOC other than Indirect (e.g. subcontract, Subcontract, Labor). 

		Step 1. Create cte, NonODC, and load it with WP/PP where EOC <> ODC OR Indirect
		Step 2. Left join NonODC to cost data that has been filtered for EOC = ODC.
