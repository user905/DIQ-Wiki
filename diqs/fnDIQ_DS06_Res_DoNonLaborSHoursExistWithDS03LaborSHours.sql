...
(
	/*
		...
		Then, we join DS04 to DS06 by task ID & subproject ID to get non-labor budgets recorded in hours 
		by Schedule WBS ID & subproject ID (where resource type <> Labor AND resource UOM = h), and insert into a cte, ScheduleWBS.
		...
		the problem WBSs (by subproject).
