...
(
	...
	/*
		This function looks for WP WADs with material budget dollars where no material BCWSi
		exists in DS03.

		To do this, we create a cte, NonMaterialWP, where we look for WP WBSs 
		that do not exist in the list of Material WP IDs.

		We then join back to DS08 by WP WP ID to find our output rows.
	*/
