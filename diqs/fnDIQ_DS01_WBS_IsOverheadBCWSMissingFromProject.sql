...
(
	/*
		...
		October 2023: Overhead has been replaced with Indirect. This DIQ has therefore been DELETED and replaced with fnDIQ_DS03_Cost_IsIndirectBCWSMissingFromProject.
	*/	
    SELECT	*
    FROM	DS01_WBS
