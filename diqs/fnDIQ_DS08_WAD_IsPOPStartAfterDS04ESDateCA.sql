...
(
	...
	/*
		This function looks for CA WADs where POP Start > BL DS04.ES Date (by WBS ID).

		Use a cte, SchedStart, to collect min BL ES Dates by CA/SLPP IDs using a join between DS04 & AncestryTree_Get.
