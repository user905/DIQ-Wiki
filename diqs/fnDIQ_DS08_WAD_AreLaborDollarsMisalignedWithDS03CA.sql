...
(
	...
	/*
		This function looks for CA WADs where the labor budget dollars <> labor BCWSc in DS03.

		To do this, we create a cte, LaborCA, where we get BCWSc_dollars by WBS_ID_CA
