...
(
	...
	/*
		This function looks for DS21 rows where resource_ID by EOC NOT IN DS06.resource_ID (FC).
		To do this, left join to DS06 by resource ID & EOC, and then filter for missed joins.
	*/
	SELECT R.*
