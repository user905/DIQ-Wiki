...
(
	/*
		...
		It does this by left joining DS05 to DS04 by schedule type, predecessor ID, and predecessor_subproject_ID,
		and then filtering for any missing join (DS04.task_ID is null).
		Update 1-23-24 CAH: if predecessor subproject ID is null, assume the same subproject (this allows for backwards compatibility with v5-0-0
	*/
	with Tasks as (
