...
(
	...
	/*
		This function looks for tasks on the BL driving path where the FC AF date is earlier than the BL EF date.

		The query joins DP BL tasks to their FC equivalent and compares the FC AF Date to the BL EF Date.
	*/
	with BLDPTask as (
