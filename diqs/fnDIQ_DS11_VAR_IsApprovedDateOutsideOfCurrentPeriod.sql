...
(
	...
	/*
		This function looks for approved_dates not between the last CPP SD & the current CPP SD. 
		(use DS03.period_date to find the last CPP SD)

		To get the last CPP SD, we use ROW_NUMBER (sorted by DESC), 
