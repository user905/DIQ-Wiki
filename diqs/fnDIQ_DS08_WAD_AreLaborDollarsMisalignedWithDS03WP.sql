...
(
	...
	/*
		This function looks for WP WADs where the labor budget dollars <> labor BCWSc in DS03.

		To do this, we create a cte, LaborWP, where we get BCWSc_dollars by WBS_ID_WP
