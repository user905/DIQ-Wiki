...
(
	...
	/*
		October 2023: Due to DID v5 changes, this has replaced fnDIQ_DS08_WAD_AreOverheadDollarsMisalignedWithDS03CA

		This function looks for CA WADs where the Indirect budget dollars <> Indirect BCWSc in DS03.

		Step 1. Dump all indirect BCWS by CA ID into a cte, IndirectCA.

		Step 2. Join to DS08 by CA ID and compare to budget_indirect_dollars
	*/
