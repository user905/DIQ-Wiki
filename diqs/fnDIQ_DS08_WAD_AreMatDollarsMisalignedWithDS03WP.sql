...
(
	...
	/*
		This function looks for WP WADs where the material budget dollars <> material BCWSc in DS03.

		To do this, we create a cte, MaterialWP, where we get BCWSc_dollars by WBS_ID_WP

		We then join back to DS08 by WP ID to find our output rows.
	*/
