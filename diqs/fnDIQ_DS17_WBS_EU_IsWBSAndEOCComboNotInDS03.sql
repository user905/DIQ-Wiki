...
(
	/*
		Update: Nov 2023. DID v5 introduced an is_indirect column, which is used to target instances where EOC <> 'Indirect' but the row still represents Indirect data.
		To account for this we convert any EOC that isn't 'Indirect' to 'Indirect' if is_indirect = Y. We do this using a CASE.
