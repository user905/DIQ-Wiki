...
(
	...
	*/
	...
	with CostEOCs as (
		...
		--Tasks that make up the problem WBSs
		--Not all of these will be problematic
		--the problem tasks will returned in the step below once we join back to DS06 by task ID, subproject ID, and EOC
