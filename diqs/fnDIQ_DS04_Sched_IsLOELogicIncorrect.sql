...
(
	...
	*/
	...
	--LOE and apportioned tasks without at least two predecessors (one SS, one FF) or without immediate discrete predecessor (#1 & 3 above)
	SELECT S.*
	...
	UNION 
	--LOE and apportioned tasks with successors (join the LOE & Apportioned tasks to DS05 by predecessor_task_ID & predecessor_subproject_ID)
	SELECT S.*
