...
(
	...
	/*
		This function looks for tasks where the % complete type = units but DS06 resource EOCs are not material.

		We first create the NonMatRes cte to collect non-material resources by schedule_type, task_id, and subproject_ID.
		We then join that to tasks with PC_Type = units in (DS04) by task_ID, schedule_type, and subproject_ID.
	*/
	with NonMatRes as (
