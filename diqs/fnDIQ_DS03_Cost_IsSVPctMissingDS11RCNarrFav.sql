...
<documentation>
  ...
  <title>SV Percent without Root Cause Narrative (Favorable)</title>
  <summary>Is a root cause narrative missing for this CA where the SV percent is tripping the favorable percent threshold?</summary>
  <message>DS03.SVc % (|(BCWP - BCWS) / BCWS|) &gt; |DS07.threshold_schedule_cum_pct_fav| &amp; DS11.narrative_RC_SVc is missing or blank (by DS03.WBS_ID_CA &amp; DS11.WBS_ID).</message>
...
(
	...
	/*
		...
		Specifically, the check is: |(BCWPc - BCWSc) / BCWSc| > |threshold_schedule_cum_pct_fav| 
