...
(
	...
	/*
		This function looks for LOE tasks with FF successor relationships.
		(In other words, FF tasks with LOE predecessors should not exist.)

		To do this, join DS04 task_ID to DS05 predecessor_task_ID (to get the logic from pred to succ) 
		and then filter logic type = FF & task type = LOE or task EVT = A.
	*/
	with Tasks as (
