...
(
	...
	/*
		This function looks for WBS Summary tasks with resources.
		It does this by joining start/finish milestones in the schedule to the resources table 
		by task_ID, schedule_type, and subproject_ID.
