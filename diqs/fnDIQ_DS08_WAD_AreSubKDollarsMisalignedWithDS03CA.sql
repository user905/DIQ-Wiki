...
(
	...
	/*
		This function looks for CA WADs where the subcontract budget dollars <> subcontract BCWSc in DS03.

		To do this, we create a cte, SubcontractCA, where we get BCWSc_dollars by WBS_ID_CA
