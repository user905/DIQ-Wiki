...
<documentation>
  ...
  <title>Cost Actuals without Resource Performance (WP)</title>
  <summary>Are there actuals in cost without performance in resources (by WP WBS &amp; EOC)?</summary>
  <message>Resource performance (actual_dollars) = 0 even though DS03.ACWPc &gt; 0 (SUM of ACWSi_dollars) by WBS_ID_WP &amp; EOC.</message>
...
(
	...
	/*
		...
		is missing when DS03 WP actuals (ACWP) are not.
	...
	*/
	...
	with CostWBS as (
		...
		--get DS04 WBS IDs, DS06 Subproject IDs, and DS06 EOCs where the resource Performance = 0 (by EOC)
		...
		--join back to schedule to get flags by *task ID*
		--which is needed to join back to Resources.
