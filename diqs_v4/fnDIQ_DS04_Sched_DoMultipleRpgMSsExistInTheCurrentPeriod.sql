...
(
	/*
		This function looks for the existence of multiple RPG MSs (ms_level = 138) within the current period.
		
		It first gets the RPG MSs within the last 35 days of the CPP status date.
