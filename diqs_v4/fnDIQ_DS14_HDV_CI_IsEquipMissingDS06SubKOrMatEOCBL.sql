...
<documentation>
  ...
  <title>Equipment Without Subcontract or Material Resources (BL)</title>
  <summary>Is the equipment for this HDV-CI missing accompanying baseline subcontract or material resources?</summary>
  <message>equipment_ID found where subK_ID not in DS13.subK_ID list with DS06 BL resources of EOC = material or subcontract (by DS14.subK_ID &amp; DS13.subK_ID, and DS13.task_ID &amp; DS06.task_ID).</message>
...
(
	...
	/*
		...
		a DS06.EOC = material or subcontract resource does not exist for BL resources.
