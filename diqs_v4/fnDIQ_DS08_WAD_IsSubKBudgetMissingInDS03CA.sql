...
(
	...
	/*
		This function looks for CA WADs with subcontract budget dollars where no subcontract BCWSi
		exists in DS03.

		To do this, we create a cte, NonSubcontractCA, where we look for CA WBSs that have WP IDs
		that do not exist in the list of subcontract WP IDs.
