...
(
	...
	/*
		This function looks for CA WADs with labor budget dollars where no labor BCWSi
		exists in DS03.

		To do this, we create a cte, NonLaborCA, where we look for CA WBSs that have WP IDs
