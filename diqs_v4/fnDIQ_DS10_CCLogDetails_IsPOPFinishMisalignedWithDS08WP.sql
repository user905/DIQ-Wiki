...
(
	...
	/*
		This function looks to see whether WP-level transactions have a pop finish in
		...
		The cte, WADFinish, collects the latest WAD by WBS_ID_WP (Ds08.WBS_ID_WP is the WP-level WBS),
		with the POP Finish.
