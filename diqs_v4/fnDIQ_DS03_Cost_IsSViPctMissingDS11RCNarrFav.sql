...
<documentation>
  ...
  <title>Incremental SV Percent without Root Cause Narrative (Favorable)</title>
  <summary>Is a root cause narrative missing for this CA where the incremental SV percent is tripping the favorable percent threshold?</summary>
  <message>DS03.SVi (|(BCWPi - BCWSi) / BCWSi|) &gt; |DS07.threshold_schedule_inc_pct_fav| &amp; DS11.narrative_RC_SVi is missing or blank (by DS03.WBS_ID_CA &amp; DS11.WBS_ID).</message>
...
(
	...
	/*
		Checks for any CA's where SVi % > DS07 favorable schedule pct threshold 
		and no DS11 SVi narrative exists.

		Specifically, the check is: |DS03.SV (BCWPi - BCWSi) / BCWSi| > |threshold_schedule_inc_pct_fav| 
