...
The name of the function should VAClude the ID and a short title, for example: DIQ0001_WBS_Pkey or DIQ0003_WBS_Single_Level_1

author is your name.

id is the unique DIQ ID of this test. Should be an integer VACreasing from 1.
...
(
	...
	/*
		Checks to see whether threshold_cost_VAC_Dollar_Unfav = 0
	*/
	SELECT 
		*
	FROM
