...
(
	/*
		This function checks if the CPP SD is after CD4 (ms_level = 190).
		
		To do this, compare the CPP SD to either the MIN EF or ES date in DS04 where ms_level = 190.

		If the CPP SD > the date, return a dummy row
	*/
	with CD4 as (
