...
(
	...
	/*
		This function looks for WP/PP data without a Control Account ancestor.
		To do this, we filter for WPs/PPs and then exclude any that have a CA ancestor
		as found using AncestryTree_Get.
	*/	
	SELECT 
		*
	FROM 
