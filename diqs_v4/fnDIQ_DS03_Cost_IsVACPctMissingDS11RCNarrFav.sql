...
<documentation>
  ...
  <title>VAC Percent without Root Cause Narrative (Favorable)</title>
  <summary>Is a root cause narrative missing for this CA where the VAC % is tripping the favorable percent threshold?</summary>
  <message>|(BCWSi_dollars - ACWPi_dollars - ETCi_dollars) / BCWSi_dollars| &gt; |DS07.threshold_cost_VAC_pct_fav| &amp; DS11.narrative_overall is missing or blank where DS11.narrative_type = 120 (by DS03.WBS_ID_CA &amp; DS11.WBS_ID).</message>
...
(
	...
	/*
		Checks for any CA's where VAC % > the favorable threshold and there is 
		no DS11 overall narrative.

		Specifically, the check is: |DS03.VAC (DB - EAC / DB| > |threshold_cost_VAC_pct_fav| 
