...
(
	...
	/*
		This function looks for CA WADs where the labor budget Hours <> labor BCWSc in DS03.

		To do this, we create a cte, LaborCA, where we get BCWSc_Hours by WBS_ID_CA
