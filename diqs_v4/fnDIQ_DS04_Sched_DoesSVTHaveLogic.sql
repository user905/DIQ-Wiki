...
<documentation>
  ...
  <message>SVT (subtype = SVT or ZBA) task_id found in DS05 task_ID list.</message>
...
(
	...
	/*
		This function looks for SVTs with logic.

		It does this by joining SVT rows to the DS05 Logic file by task_id & schedule_type,
		with any returned rows being a flag.
	*/
	with Logic as (
