...
(
	...
	/*
		...
		It does this by joining the DS04.WBS_ID to DS01.WBS_ID (filtered for CA & WBS types) to get the list of CA & WBS WBS_IDs.
		It also joins DS04 to DS06 by DS04.task_ID & schedule_type.
