...
(
	...
	/*
		...
		Using the cte, we find the milestone_levels with duplicates by schedule_type.
		We do this using the group by & having clauses.
		Returned rows in the cte represent milestone_levels that appear more than once (by schedule type).

		Joining the results to DS04 by milestone_level and schedule_type returns the failed rows.
