...
(
	...
	/*
		This function looks for tasks missing in the resources file (less SVTs & ZBAs).
		It does this by left joining schedule (subtype NOT IN SVT/ZBA) to resources (DS06) by task_ID and schedule type.
