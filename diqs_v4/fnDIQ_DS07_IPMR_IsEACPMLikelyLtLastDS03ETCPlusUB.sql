...
(
	/*
		This function checks to see if the EAC PM likely date is before
		the last recorded ETCi date + UB EST days.

		Because the test is on calendar days, we need to add a weekend factor to the UB EST days,
