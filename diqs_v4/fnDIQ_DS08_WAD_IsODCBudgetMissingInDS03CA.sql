...
(
	...
	/*
		This function looks for CA WADs with ODC budget dollars where no ODC BCWSi
		exists in DS03.

		To do this, we create a cte, NonODCCA, where we look for CA WBSs that have WP IDs
