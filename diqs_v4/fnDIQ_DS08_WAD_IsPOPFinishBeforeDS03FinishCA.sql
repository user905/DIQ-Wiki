...
(
	...
	/*
		This function looks for CA WADs where pop finish < the last recorded DS03.SPAE value.
		To do this, we get the last WAD revision (by pm auth date), 
		as well as the last DS03.period_date and compare.

		The CostFinish cte gets loaded with the last recorded SPAE value by CA WBS ID.
