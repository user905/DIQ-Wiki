...
(
	...
	/*
		This function looks for non-SVT/non-ZBA tasks/activities that are forecasted to 
		start or finish after the end of the PMB.

		Using a cte, we first collect ES/EF dates from DS04 by schedule type.
		We then join this to DS04 by schedule type, and compare the ES/EF dates of the
		DS04 tasks to the end of pmb ES/EF dates.
