...
(
	...
	/*
		This function looks for milestones with duration, be it actual or original,
		or where start and finish dates are not the same.

		It does this by excluding non-start and finish milestones (i.e. type = SM or FM)
		and filtering for any start/finish dates with discrepancies or any durations <> 0.
	*/
