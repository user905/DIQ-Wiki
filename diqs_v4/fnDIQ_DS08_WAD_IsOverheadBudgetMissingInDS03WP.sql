...
(
	...
	/*
		This function looks for WP WADs with overhead budget dollars where no overhead BCWSi
		exists in DS03.

		To do this, we create a cte, NonOverheadWP, where we look for WP WBSs that
