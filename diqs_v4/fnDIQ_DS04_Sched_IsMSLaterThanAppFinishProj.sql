...
(
	...
	/*
		...
		To do this, we collect the ES Date for the ms_level = 199 milestone by schedule_type in cte, MS199.
		Then join to the schedule by schedule_type and compare the EF_Dates
	*/
