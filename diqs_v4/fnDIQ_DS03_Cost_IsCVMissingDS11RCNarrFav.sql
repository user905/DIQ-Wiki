...
<documentation>
  ...
  <title>CV without Root Cause Narrative (Favorable)</title>
  <summary>Is a root cause narrative missing for this CA where the CV is tripping the favorable dollar threshold?</summary>
  <message>DS03.CVc (|BCWP - ACWP|) &gt; |DS07.threshold_cost_cum_dollar_fav| &amp; DS11.narrative_RC_CVc is missing or blank (by DS03.WBS_ID_CA &amp; DS11.WBS_ID).</message>
...
(
	...
	/*
		Checks for any CA's where CV > the favorable threshold and 
		no DS11 CV narrative exists.

		Specifically, the check is: |DS03.CV (BCWPc - ACWPc)| > |threshold_cost_cum_dollar_fav| 
