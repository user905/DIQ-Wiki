...
<documentation>
  ...
  <title>CV Percent without Root Cause Narrative (Unfavorable)</title>
  <summary>Is a root cause narrative missing for this CA where the CV percent is tripping the unfavorable percent threshold?</summary>
  <message>DS03.CVc % (|(BCWP - ACWP) / BCWP|) &gt; |DS07.threshold_cost_cum_dollar_unfav| &amp; DS11.narrative_RC_CVc is missing or blank (by DS03.WBS_ID_CA &amp; DS11.WBS_ID).</message>
...
(
	...
	/*
		Checks for any CA's where CV % > the unfavorable threshold and there is 
		no DS11 CV narrative.

		Specifically, the check is: |(BCWPc - ACWPc) / BCWPc| > |threshold_cost_cum_pct_unfav| 
