...
(
	...
	/*
		...
		NOTE ON LEAD: Lead uses PARTITION BY schedule_type to ensure that the current row looks only at the next row
		**within the same schedule**.
		Example: https://www.db-fiddle.com/f/kSDF7NFY4vhoJQGpYYYq7C/2
	*/
