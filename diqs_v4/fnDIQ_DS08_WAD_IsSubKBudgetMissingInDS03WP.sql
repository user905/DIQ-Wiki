...
(
	...
	/*
		This function looks for WP WADs with subcontract budget dollars where no subcontract BCWSi
		exists in DS03.

		To do this, we create a cte, NonSubcontractWP, where we look for WP WBSs that
