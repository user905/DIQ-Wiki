...
(
	...
	/*
		Checks for any CA's where SVi % > DS07 unfavorable schedule pct threshold 
		and no DS11 SVi narrative exists.

		Specifically, the check is: |DS03.SV (BCWPi - BCWSi) / BCWSi| > |threshold_schedule_inc_pct_unfav| 
