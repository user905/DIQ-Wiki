...
(
	...
	/*
		This function looks for resources where resource labor performance units exists 
		...
		Then, we join DS04 to DS06 by task ID to get labor performance by Schedule WBS ID, and
